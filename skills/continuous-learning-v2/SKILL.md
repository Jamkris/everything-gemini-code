...
```json
{
  "hooks": {
    "PreToolUse": [{
      ...
      "hooks": [{
        "type": "command",
        "command": "~/.gemini/skills/continuous-learning-v2/hooks/observe.sh pre"
      }]
    }],
    "PostToolUse": [{
      "matcher": "*",
      "hooks": [{
        "type": "command",
        "command": "~/.gemini/skills/continuous-learning-v2/hooks/observe.sh post"
      }]
    }]
  }
}
...
```bash
mkdir -p ~/.gemini/homunculus/{instincts/{personal,inherited},evolved/{agents,skills,commands}}
touch ~/.gemini/homunculus/observations.jsonl
```
...
```json
{
  ...
  "observation": {
    "enabled": true,
    "store_path": "~/.gemini/homunculus/observations.jsonl",
    "max_file_size_mb": 10,
    "archive_after_days": 7
  },
  "instincts": {
    "personal_path": "~/.gemini/homunculus/instincts/personal/",
    "inherited_path": "~/.gemini/homunculus/instincts/inherited/",
    "min_confidence": 0.3,
  ...
  "evolution": {
    "cluster_threshold": 3,
    "evolved_path": "~/.gemini/homunculus/evolved/"
  }
}
```
...
- Existing `~/.gemini/skills/learned/` skills still work
...
*Instinct-based learning: teaching Gemini your patterns, one observation at a time.*
