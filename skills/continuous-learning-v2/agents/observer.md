...
A background agent that analyzes observations from Gemini CLI sessions to detect patterns and create instincts.
...
Reads observations from `~/.gemini/homunculus/observations.jsonl`:
...
Creates/updates instincts in `~/.gemini/homunculus/instincts/personal/`:
