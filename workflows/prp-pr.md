...
| Clean working directory | No uncommitted changes | Warn: "You have uncommitted changes. Commit or stash first. Use `/egc-prp-commit` to commit." |
...
Next steps:
  ...
  - /egc-code-review <number>       → review the PR
