/**
 * Cross-platform utility functions for Gemini CLI hooks and scripts
...
function getSessionsDir() {
  return path.join(getGeminiDir(), 'sessions');
}
...
function getLearnedSkillsDir() {
  return path.join(getGeminiDir(), 'skills', 'learned');
}
...
/**
 * Log to stderr (visible to user in Gemini CLI)
 */
