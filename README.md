...
[![Forks](https://img.shields.io/github/forks/Jamkris/everything-gemini-code?style=flat)](https://github.com/Jamkris/everything-gemini-code/network/members)
[![Contributors](https://img.shields.io/github/contributors/Jamkris/everything-gemini-code?style=flat)](https://github.com/Jamkris/everything-gemini-code/graphs/contributors)
...
[**English**](README.md) | [한국어](README.ko.md) | [简体中文](README.zh-CN.md) | [繁體中文](docs/zh-TW/README.md)

</div>

---

**The complete collection of Gemini CLI configs from an Anthropic hackathon winner.**
...
<img src="https://github.com/user-attachments/assets/1a471488-59cc-425b-8345-5245c7efbcef" alt="The Shorthand Guide to Everything Gemini CLI" />
</a>
</td>
<td width="50%">
<a href="https://x.com/affaanmustafa/status/2014040193557471352">
<img src="https://github.com/user-attachments/assets/c9ca43bc-b149-427f-b551-af6840c368f0" alt="The Longform Guide to Everything Gemini CLI" />
</a>
</td>
</tr>
<tr>
...
See the full changelog in [Releases](https://github.com/Jamkris/everything-gemini-code/releases).
...
This plugin requires Gemini CLI v2.1.0+ due to changes in how the plugin system handles hooks.
...
> ⚠️ **For Contributors:** Do NOT add a `"hooks"` field to `.gemini-plugin/plugin.json`. This is enforced by a regression test.
...
**History:** This has caused repeated fix/revert cycles in this repo ([#29](https://github.com/Jamkris/everything-gemini-code/issues/29), [#52](https://github.com/Jamkris/everything-gemini-code/issues/52), [#103](https://github.com/Jamkris/everything-gemini-code/issues/103)). The behavior changed between Gemini CLI versions, leading to confusion. We now have a regression test to prevent this from being reintroduced.
...
```json
{
  ...
  "enabledPlugins": {
    "everything-gemini-code@everything-gemini-code": true
  }
}
```
...
> cp -r everything-gemini-code/rules/common/* ~/.gemini/rules/
> cp -r everything-gemini-code/rules/typescript/* ~/.gemini/rules/   # pick your stack
> cp -r everything-gemini-code/rules/python/* ~/.gemini/rules/
> cp -r everything-gemini-code/rules/golang/* ~/.gemini/rules/
>
...
Copy the hooks from `hooks/hooks.json` to your `~/.gemini/settings.json`.

#### Configure MCPs

Copy desired MCP servers from `mcp-configs/mcp-servers.json` to your `~/.gemini.json`.
...
| ------------ | -------------- | ----------------- | ---------------------- |
| Agents       | ✅ 14 agents   | ✅ 12 agents      | **Gemini CLI leads**   |
| Commands     | ✅ 30 commands | ✅ 24 commands    | **Gemini CLI leads**   |
| Skills       | ✅ 28 skills   | ✅ 16 skills      | **Gemini CLI leads**   |
...
I've been using Gemini CLI since the experimental rollout. Won the Anthropic x Forum Ventures hackathon in Sep 2025 building [zenith.chat](https://zenith.chat) with [@DRodriguezFX](https://x.com/DRodriguezFX) - entirely using Gemini CLI.
...
[![Star History Chart](https://api.star-history.com/svg?repos=Jamkris/everything-gemini-code&type=Date)](https://star-history.com/#Jamkris/everything-gemini-code&Date)

---

## 🔗 Links

- **Shorthand Guide (Start Here):** [The Shorthand Guide to Everything Gemini CLI](https://x.com/affaanmustafa/status/2012378465664745795)
- **Longform Guide (Advanced):** [The Longform Guide to Everything Gemini CLI](https://x.com/affaanmustafa/status/2014040193557471352)
