...
- [커맨드-에이전트 매핑](COMMAND-AGENT-MAP.md) — 각 커맨드가 호출하는 에이전트
- [스킬 배치 정책](SKILL-PLACEMENT-POLICY.md) — 스킬 파일 배치 규칙
- [토큰 최적화](token-optimization.md) — 토큰 사용량 관리
- [설치 검증 가이드](VERIFICATION_GUIDE.md) — 확장 설치 검증
