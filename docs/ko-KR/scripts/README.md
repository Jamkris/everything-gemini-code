...
**언어:** [English](../../en/scripts/README.md) | **한국어**
...
| 스크립트 | 설명 |
|----------|------|
| `harness-audit.js` | 핵심 Gemini CLI 규칙에 대한 저장소 상태를 검사(Audit)합니다. 토큰/컨텍스트 최적화 가이드 제공 여부, 훅 구성 파일, Eval 커버리지, 보안 가드레일 등을 평가합니다. <br><br> **사용법:** `node scripts/egc-harness-audit.js --scope repo` |
